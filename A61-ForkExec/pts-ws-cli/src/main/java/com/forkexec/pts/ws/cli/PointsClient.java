...
public class PointsClient {
	...
	public Response<ActivateUserResponse> activateUserAsync(String userEmail) throws EmailAlreadyExistsFault_Exception, InvalidEmailFault_Exception {
		return port.activateUserAsync(userEmail);
	}

	public BalanceInfo pointsBalance(String userEmail) throws InvalidEmailFault_Exception {
	...
	public Response<SetBalanceResponse> setBalanceAsync(final String userEmail, final int balance, final int tag)
			throws InvalidEmailFault_Exception, InvalidPointsFault_Exception {
		return port.setBalanceAsync(userEmail, balance, tag);
	}
	...
	public Response<CtrlInitResponse> ctrlInitAsync(int startPoints) throws BadInitFault_Exception {
