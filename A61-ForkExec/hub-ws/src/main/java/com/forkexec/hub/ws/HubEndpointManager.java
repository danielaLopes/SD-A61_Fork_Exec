...
public class HubEndpointManager {
	...
	/** Get CC url for contacting CC server */
	String getCCUrl() {
		return ccURL;
	}
	...
	public HubEndpointManager(String uddiURL, String wsName, String wsURL, String ccURL) {
	...
	public void start() throws Exception {
		...
		publishToUDDI();
		// set names needed by Hub, has to be here, otherwise endpointManager will not have been initialized
		Hub.getInstance().setUddiNaming(getUddiNaming());
		Hub.getInstance().setCcUrl(getCCUrl());
		Hub.getInstance().createPointsFrontEnd();
	}
